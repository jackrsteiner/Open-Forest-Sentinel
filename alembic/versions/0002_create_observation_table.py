...
Revision ID: 0002_create_observation_table
...
revision: str = "0002_create_observation_table"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["aoi_id"], ["aoi.id"], name="fk_observation_aoi_id_aoi"
        ),
        sa.UniqueConstraint(
            "aoi_id",
            "source_scene_id",
    ...
    op.create_index(
        "ix_observation_aoi_id_acquired_at",
        "observation",
        ["aoi_id", "acquired_at"],
    )
