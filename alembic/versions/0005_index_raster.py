...
Revision ID: 0005_index_raster
Revises: 0004_quality_mask
...
revision: str = "0005_index_raster"
down_revision: str | None = "0004_quality_mask"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name="fk_index_raster_methodology_version_id_methodology_version",
        ),
